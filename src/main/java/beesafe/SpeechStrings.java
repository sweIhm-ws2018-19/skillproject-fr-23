...
public class SpeechStrings {
	...
	public static final String risikoBeiStich_Message = "Das haert sich nicht gut an! <break time =\"0.2s\"/>Es waere besser wenn du in die naechste Notaufnahme gehst! Soll ich dir einen Krankenwagen rufen?"; 
	public static final String risikoBeiStich_Message_Reprompt = "Geh lieber in die naechste Notaufnahme."; 
	public static final String risikoEinesSonnenstichs_Message = "Oh nein, dann hast du moeglicherweise einen Sonnenstich und solltest zu einem Arzt gehen. Hier sind die naechsten Notaufnahmen:"; 
	public static final String risikoEinesSonnenstichs_Message_Reprompt = "Bei einem Sonnenstich solltest du lieber zur naechsten Notaufnahme gehen."; 
	...
	public static final String risikoBeiSonnenbrand_Message_Reprompt = "Geh lieber zu einem Arzt oder in die naechste Notaufnahme."; 
